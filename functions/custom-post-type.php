...
function custom_post_example() { 
        ...
        register_post_type( 'custom_type', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
                ...
                array( 'labels' => array(
                        'name' => __( 'Custom Types', 'kindlingtheme' ), /* This is the Title of the Group */
                        'singular_name' => __( 'Custom Post', 'kindlingtheme' ), /* This is the individual type */
                        'all_items' => __( 'All Custom Posts', 'kindlingtheme' ), /* the all items menu item */
                        ...
                        'description' => __( 'This is the example custom post type', 'kindlingtheme' ), /* Custom Type Description */
                        'public' => true,
...
function content_metaboxes( $meta_boxes ) {
	global $prefix;
	$meta_boxes[] = array(
		'id' => 'content_metabox',
		'title' => 'Content',
...
add_filter( 'cmb_meta_boxes', 'content_metaboxes' );    
